...
export function CommunityRow({
    ...
    return (
        <div
            className={cn(
                "flex items-center gap-3 py-4 border-b border-zinc-200",
                community.optimistic ? "opacity-75" : "",
            )}>
            ...
            <Popover>
                ...
                <PopoverContent
                    ...
                    <form
                        onSubmit={(event) => {
                            ...
                            startTransition(async () => {
                                try {
                                    ...
                                    onLeaveError?.();
                                    toast.error(
                                        "Could not leave that community. Try again.",
                                    );
                                }
                            });
                        }}>
                        ...
                        />
                        <Button
                            className="h-9 w-full rounded-md normal-case tracking-normal"
                            disabled={pending || community.optimistic}
                            type="submit"
                            variant="destructive">
                            {pending || community.optimistic
                                ? "Leaving..."
                                : "Leave"}
                        </Button>
                    </form>
