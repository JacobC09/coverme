    ...
    return (
        <Drawer onOpenChange={setOpen} open={open} showSwipeHandle>
            <DrawerTrigger
                render={
                    <Button
                        className="rounded-md border-primary/25 bg-white text-primary normal-case tracking-normal hover:bg-zinc-50"
                        variant="outline">
            ...
            <DrawerContent className="rounded-t-lg sm:mx-auto sm:max-w-md sm:rounded-lg">
                <form
                    onSubmit={async (event) => {
                        ...
                        try {
                            const result =
                                await createCommunityResult(formData);
                            if (result.ok) {
                            ...
                            setAddress(nextAddress);
                            toast.error(
                                "Could not create that community. Try again.",
                            );
                        } finally {
                            setPending(false);
                        }
                    ...
                    <DrawerHeader className="text-left">
                        ...
                        <DrawerDescription>
                            Make a shared space for people who can see and claim
                            shifts.
                        </DrawerDescription>
                    </DrawerHeader>
                    ...
                    <div className="grid gap-5 px-4">
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                placeholder="Oakville Lifeguards"
                                required
                                value={name}
                            />
                        </div>
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                placeholder="Town of Oakville"
                                value={companyName}
                            />
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="communityAddress">
                                Address{" "}
                                <span className="text-zinc-400">
                                    (optional)
                                </span>
                            ...
                            <Input
                                ...
                                placeholder="Community centre address"
                                value={address}
                            />
                        </div>
                    </div>
